    ...
    render() {
        return (
            <div className="relative h-screen flex items-center justify-center">
                ...
                <div className="captcha-container bg-white bg-opacity-30 backdrop-blur-lg rounded-lg z-40 shadow-lg p-16 w-4/5 max-w-4xl h-[600px] flex flex-col items-center">
                    <div className="captcha-header text-center font-bold text-4xl text-gray-700 mb-8">CAPTCHA</div>
                    <LoadCanvasTemplate />
                    <input
                        className="captcha-input mt-8 p-6 border rounded-lg w-full text-xl placeholder-black focus:outline-none focus:ring-2 focus:ring-blue-500"
